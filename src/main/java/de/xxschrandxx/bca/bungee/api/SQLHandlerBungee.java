...
public class SQLHandlerBungee extends SQLHandler {
   ...
   */
  public SQLHandlerBungee(Path SQLProperties, Logger Logger, Boolean isDebug) throws SQLException {
   ...
   * @throws SQLException {@link SQLException}
   */
  public String getRegisteredIP(ProxiedPlayer player) throws SQLException {
    if (player == null) {
      logger.warning("SQLHandlerBungee.getRegisteredIP | ProxiedPlayer is null, skipping");
      return null;
    }
    return getRegisteredIP(player.getUniqueId());
  }
